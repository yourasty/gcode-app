function start_freespace(inputs, tool) {
  const code = `%
O6002(FREESPACE)
...
#100=${inputs.freespace_x}(DISTANCE FROM CORNER)
#101=${inputs.freespace_between}(DISTANCE BETWEEN)
#103=${inputs.freespace_inwall}(DEPTH IN WALL)
#104=${inputs.freespace_flat}(FLAT SURFACE)
#105=${inputs.freespace_plunge_n}(NUMBER OF PLUNGE PASSES)
#115=${inputs.freespace_depth}(STRAIGHT PLUNGE DEPTH)
#120=${inputs.freespace_radius*2}(PLUNGE DIAMETER=x2 FREESPACE RADIUS)
...
export default start_freespace;
